...
## Running the project
You can follow the easy steps below to setup a local instance of Project HeadBoard for Android:
...
- Pause/Unpause cursor - Pause or unpause HeadBoard virtual cursor movement 
