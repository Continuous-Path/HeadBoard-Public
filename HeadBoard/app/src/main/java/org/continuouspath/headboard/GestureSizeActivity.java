...
public class GestureSizeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (thresholdInUi < 10) thresholdInUi = seekBarDefaultValue * 10;
        else thresholdInUi = MathUtils.clamp(thresholdInUi, SEEK_BAR_LOW_CLIP, SEEK_BAR_HIGH_CLIP);
        gestureSizeSeekBar.setMax(SEEK_BAR_MAXIMUM_VALUE);
        gestureSizeSeekBar.setMin(SEEK_BAR_MINIMUM_VALUE - 1);
        ...
        findViewById(R.id.Bigger).setOnClickListener(v -> {
            ...
            int newValue = MathUtils.clamp(currentValue + 1, SEEK_BAR_MINIMUM_VALUE, SEEK_BAR_MAXIMUM_VALUE);
