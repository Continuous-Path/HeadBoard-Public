...
import org.continuouspath.headboard.R;
...
public class ChooseGestureActivityTest {
    ...
    SharedPreferences preferences = ApplicationProvider.getApplicationContext().getSharedPreferences("HeadBoardLocalConfig", Context.MODE_PRIVATE);
